...
public:
  ...
  using RclInit =
    ContainerTraits<const void *>;
  using RclNodeInit =
    ContainerTraits<const void *, const void *, const char *, const char *>;
  using RclSubscriptionInit =
    ContainerTraits<const void *, const void *, const void *,
      const char *, size_t>;
  using RclcppCallbackRegister =
    ContainerTraits<const void *, const char *>;
  using RclcppSubscriptionInit =
    ContainerTraits<const void *, const void *>;
  using RclcppSubscriptionCallbackAdded =
    ContainerTraits<const void *, const void *>;
  using RclcppTimerCallbackAdded =
    ContainerTraits<const void *, const void *>;
  using RclcppTimerLinkNode =
    ContainerTraits<const void *, const void *>;
  using RclTimerInit =
    ContainerTraits<const void *, int64_t>;
  using RclPublisherInit =
    ContainerTraits<const void *, const void *, const void *,
      const char *, size_t>;
  using RclClientInit =
    ContainerTraits<const void *, const void *, const void *, const char *>;
  using RclcppServiceCallbackAdded =
    ContainerTraits<const void *, const void *>;
  using RclServiceInit =
    ContainerTraits<const void *, const void *, const void *, const char *>;
  using RmwImplementation =
