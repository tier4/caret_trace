...
TEST(ScenarioTest, TestSingleThread) {
  ...
  DataContainer container(
    ...
    nullptr, nullptr, nullptr, nullptr, keys,
    nullptr, nullptr, nullptr, nullptr, nullptr,
    nullptr, nullptr, nullptr, nullptr, nullptr,
    nullptr, nullptr
  );
...
TEST(ScenarioTest, RepetitiveRecordingCase) {
  ...
  auto node = TraceNode("test", lttng, container, rclcpp::Logger::Level::Warn);
...
TEST(ScenarioTest, IsRecordingEnabled) {
  init_context();
  ...
  auto node = std::make_shared<TraceNode>(
    "test", lttng, container, rclcpp::Logger::Level::Warn);
